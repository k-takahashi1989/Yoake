...
const styles = StyleSheet.create({
  ...
  emptyText: { fontSize: 16, color: MORNING_THEME.textSecondary, marginTop: 8 },
  emptySubText: { fontSize: 13, color: MORNING_THEME.textSecondary, textAlign: 'center', marginTop: 4 },
  scroll: { flex: 1 },
  summaryCard: {
    marginHorizontal: 16,
    marginTop: 8,
  ...
  summaryDiffFlat: { color: MORNING_THEME.textSecondary },
  summaryMainRow: {
    flexDirection: 'row',
    alignItems: 'stretch',
    justifyContent: 'space-between',
